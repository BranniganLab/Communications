...
\begin{figure}[H]
  \centering
  \subfloat{{\includegraphics[width=12cm, scale=0.25]{MS thesis/figures/random_rdf_rough_rough_distribution_peaks-trim.png}}}
  \qquad
  \subfloat{{\includegraphics[width=12cm,scale=0.25]{MS thesis/figures/random_rdf_smooth_smooth_distribution_peaks-trim.png}}}
  \qquad
  \subfloat{{\includegraphics[width=12cm,scale=0.25]{MS thesis/figures/random_rdf_smooth_rough_distribution_peaks-trim.png}}}
...
\begin{figure}[H]
  \centerline{\includegraphics[width=17cm, scale=0.4]{MS thesis/figures/artifical_order_parameter.png}}
...
\begin{figure}[H]
  ...
  \qquad
  \subfloat{{\includegraphics[width=15.2cm, scale =0.95]{MS thesis/figures/artificial_rdf_distribution_peak_rough_rough-trim.png}}}
  \qquad
    \subfloat{{\includegraphics[width=15.2cm, scale =0.95]{MS thesis/figures/artificial_rdf_distribution_peak_smooth_smooth-trimm.png}}}
