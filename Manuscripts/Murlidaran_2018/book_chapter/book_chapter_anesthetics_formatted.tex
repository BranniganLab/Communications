...
%GB: FILL IN
  \item Non-default parameters: 
	 ...
	 %GB: what size constant should be used? 
	 \end{itemize}
\end{itemize} \hfill \break
...
\begin{center}
\centering
%\includegraphics[width = 1\textwidth]{finlpics/flowchart_flooding}
...
\begin{center}
\centering
%\includegraphics[width = 1\textwidth]{finlpics/Flowchart_docking}
...
\begin{center}
\centering
%\includegraphics[width = 1\textwidth]{finlpics/Flowchart_FEP}
...
\begin{center}
\centering
%\includegraphics[width = 1\textwidth]{finlpics/PFL_dihed}
...
\begin{center}
\centering
%\includegraphics[width = 1\textwidth]{finlpics/per_lambda}
